# Archived Bootstrap and Phase Guide

This is the original blank-folder-to-Phase-7 execution guide. It is retained as historical design and verification context; completed steps and old present-tense instructions are not current work. Use `../START_HERE.md`, `../STATUS.md`, and `../TODO.md` for the live entry point.
...
---
AI-edited: 2026-08-10T16:23:50-04:00 | agent=Codex/root | model=gpt-5.6-sol | effort=max | task=repo-integrity | change=archived the completed blank-folder and phase guide behind the compact current entry point
